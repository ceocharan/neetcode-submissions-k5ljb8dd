class Solution {
    public boolean exist(char[][] board, String word) {
        ...
        boolean res=false;
        for(int i=0;i<m;i++){
            res=rec(0,i,n,m,board,word,new StringBuilder(),vis) | rec(n-1,i,n,m,board,word,new StringBuilder(),vis);
            if(res){
                return true;
            }
        ...
        for(int i=0;i<n;i++){
            res=rec(i,0,n,m,board,word,new StringBuilder(),vis) | rec(i,m-1,n,m,board,word,new StringBuilder(),vis);
            if(res){
                return true;
            }
        }
